...
builder.Services.AddScoped<IVesselTreeService, VesselTreesService>();
builder.Services.AddTransient<IVesselTreesBuilder, VesselTreesBuilder>();
...
VesselTreesEndpoint.MapEndpoints(app.MapGroup("/VesselTrees"));
